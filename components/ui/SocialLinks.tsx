    ...
    <div className={cn("flex items-center gap-3", className)}>
      {links.map((link) => (
        <motion.a
          ...
          className="flex items-center justify-center size-[34px] sm:size-[38px] rounded-full bg-surface text-ink border border-border transition-colors duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2"
          whileHover={{ scale: 1.1, backgroundColor: link.hoverColor, color: "var(--color-paper)" }}
          whileTap={{ scale: 0.9 }}
